...
WallpaperItem {
    ...
    property int charType: main.configuration.charType !== undefined ? main.configuration.charType : 0
    ...
    Canvas {
        ...
        function getChar() {
            if (main.charType === 0) {
                // ASCII
                return String.fromCharCode(0x21 + Math.floor(Math.random() * 93));
            } else if (main.charType === 1) {
                // Binary
                return String.fromCharCode(0x30 + Math.floor(Math.random() * 2));
            } else if (main.charType === 2) {
                // Braille
                return String.fromCharCode(0x2840 + Math.floor(Math.random() * 191));
            } else if (main.charType === 3) {
                // Katakana
                return String.fromCharCode(0x30a0 + Math.floor(Math.random() * 96));
            } else if (main.charType === 4) {
                // Picto
                return String.fromCharCode(0x4e00 + Math.floor(Math.random() * 20901));
            } else if (main.charType === 5) {
                // Runic
                return String.fromCharCode(0x16A0 + Math.floor(Math.random() * 88));
            }
        }
        ...
        onPaint: {
            ...
            for (var i = 0; i < drops.length; i++) {
                ...
                var color = main.colorMode === 0 ? main.singleColor : main.palettes[main.paletteIndex][i % main.palettes[main.paletteIndex].length];
